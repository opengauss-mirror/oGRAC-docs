...
- **REFERENCES [schema_name.]table_name[(column_name)] ON DELETE CASCADE**: 外键级联设置。外表删除时本表删除
- **REFERENCES [schema_name.]table_name[(column_name)] ON DELETE SET NULL**: 外键级联设置。外表删除时本表设置为NULL
